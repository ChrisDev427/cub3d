...
//----------------------------------------------------------------------------------------------------------------------------------
    //perform DDA
        ...
        // }
		game->rc.hit = 0;
		while (game->rc.hit == 0 && game->mapcpy[game->rc.map_x][game->rc.map_y] != '1')
		{
			if (game->rc.side_dist_x < game->rc.side_dist_y) //game->rc.side_dist_y <= 0 || (game->rc.side_dist_x >= 0 &&
			{
				game->rc.side_dist_x += game->rc.delta_dist_x;
				game->rc.map_x += game->rc.step_x;
				game->rc.side = 0;
		...
		// printf("mapx = %d\n",game->rc.map_x);
		// printf("mapy = %d\n",game->rc.map_y);
		// printf("chiffre = %c\n",game->mapcpy[game->rc.map_x][game->rc.map_y]);
			// printf("hit = %d\n", game->rc.hit);
		}
            // printf("%c\n", game->mapcpy[game->ipos_y][game->rc.map_x]);
//----------------------------------------------------------------------------------------------------------------------------------------
