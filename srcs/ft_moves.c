...
/*   Updated: 2023/06/12 12:55:52 by chmassa          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
    if (game->mov.moves[0] == 'u' && game->parse.mapcpy[(int)game->mov.pos_y -1][(int)game->mov.pos_x] != '1')
        game->mov.pos_y -= 0.1;
    if (game->mov.moves[1] == 'l' && game->parse.mapcpy[(int)game->mov.pos_y][(int)game->mov.pos_x -1] != '1')
        game->mov.pos_x -= 0.1;
    if (game->mov.moves[2] == 'r' && game->parse.mapcpy[(int)game->mov.pos_y][(int)game->mov.pos_x +1] != '1')
        game->mov.pos_x += 0.1;
    if (game->mov.moves[3] == 'd' && game->parse.mapcpy[(int)game->mov.pos_y +1][(int)game->mov.pos_x] != '1')
        game->mov.pos_y += 0.1;
