...
/*   Updated: 2023/06/20 14:44:47 by axfernan         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	ft_color_assign(t_game *game)
{
	...
	game->mp_data.mini_map_fov[0] = FOV_COL_A;
	game->mp_data.mini_map_fov[1] = FOV_COL_R;
	game->mp_data.mini_map_fov[2] = FOV_COL_G;
	game->mp_data.mini_map_fov[3] = FOV_COL_B;
